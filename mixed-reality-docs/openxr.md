...
Windows Mixed Reality OpenXR Runtime は、2020年7月に、一連のおよびの拡張機能をサポートしてい `MSFT` `EXT` ます。
...
| Direct3D 12 の統合 | **`KHR`[プレビューランタイム 2003](openxr-getting-started.md#using-preview-extensions)の公式拡張機能:**<br /><code><a href="https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_KHR_D3D12_enable" target="_blank">XR_KHR_D3D12_enable</a></code><br /><p>**安定したランタイムでのサポート**: 5 月 2020 *(計画済み)*</p> |
...
| [手 articulation + 手メッシュ](hands-and-tools.md)<p>*HoloLens 2 のみ*</p> | **`MSFT_preview`[プレビューランタイム 2001](openxr-getting-started.md#using-preview-extensions)の拡張機能:**<br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_hand_tracking_preview">XR_MSFT_hand_tracking_preview</a></code><br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_hand_tracking_mesh_preview">XR_MSFT_hand_tracking_mesh_preview</a></code><p>** `MSFT` または `EXT` プレビューランタイムの拡張機能: 5**月 2020 *(計画済み)*</p> |
| [目の視線入力](eye-tracking.md)<p>*HoloLens 2 のみ*</p> | ** `EXT` [プレビューランタイム 2003](openxr-getting-started.md#using-preview-extensions)の拡張機能**:<br /><code><a href="https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_EXT_eye_gaze_interaction" target="_blank">XR_EXT_eye_gaze_interaction</a></code><p>**安定したランタイムでのサポート**: 5 月 2020 *(計画済み)*</p> |
| 他の HoloLens Sdk との相互運用 ( [QR](qr-code-tracking.md)など)<p>*HoloLens 2 のみ*</p> | **`MSFT_preview`[プレビューランタイム 2001](openxr-getting-started.md#using-preview-extensions)の拡張機能:**<br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_spatial_graph_bridge_preview">XR_MSFT_spatial_graph_bridge_preview</a></code><p>** `MSFT` プレビューランタイムの拡張機能: 5**月 2020 *(計画済み)*</p> |
| [Mixed Reality キャプチャ <br /> (PV カメラからの3番目のレンダリング)](mixed-reality-capture-for-developers.md#render-from-the-pv-camera-opt-in)<p>*HoloLens 2 のみ*</p> | **`MSFT_preview`[プレビューランタイム 2003](openxr-getting-started.md#using-preview-extensions)の拡張機能:**<br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_secondary_view_configuration_preview">XR_MSFT_secondary_view_configuration_preview</a></code><br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_first_person_observer_preview">XR_MSFT_first_person_observer_preview</a></code><p>** `MSFT` プレビュー版の拡張機能**: 6 月 2020 *(計画済み)*</p> |
| [モーションコントローラーレンダリングモデル](motion-controllers.md#rendering-the-motion-controller-model) | **`MSFT_preview`[プレビューランタイム 2003](openxr-getting-started.md#using-preview-extensions)の拡張機能:**<br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_controller_model_preview">XR_MSFT_controller_model_preview</a></code><p>** `MSFT` プレビュー版の拡張機能**: 2020 年7月 *(計画)*</p> |
| [シーンの理解 (平面、メッシュ)](scene-understanding.md)<p>*HoloLens 2 のみ*</p> | <p>** `MSFT_preview` プレビュー版の拡張機能**: 6 月 2020 *(計画済み)*</p><p>** `MSFT` プレビュー版の拡張機能**: 2020 年7月 *(計画)*</p> |
