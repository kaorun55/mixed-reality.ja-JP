...
4.  **作成**:
    ...
    5. 後で使用する UWP**アプリでは**、場所として "米国西部" を使用する必要があります。
...
8.  *FaceAnalysis*クラス内で、次の変数を追加します。
    ...
    > [!NOTE]
    > **キー**およびユーザーをサービス**キーで置き換え**、前に作成したグループの Id に置き換えます。
