---
title: Microsoft Holographic のリモート処理のソフトウェア ライセンス条項
description: Microsoft Holographic のリモート処理のソフトウェア ライセンス条項
author: JonMLyons
ms.author: jlyons
ms.date: 03/21/2018
ms.topic: article
keywords: HoloLens、リモート処理では、ライセンス
ms.openlocfilehash: 30a51f4ac34482802e30bf3f6289e3fd62f367a6
ms.sourcegitcommit: 384b0087899cd835a3a965f75c6f6c607c9edd1b
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 04/12/2019
ms.locfileid: "59604891"
---
# <a name="microsoft-holographic-remoting-software-license-terms"></a><span data-ttu-id="843be-104">Microsoft Holographic のリモート処理のソフトウェア ライセンス条項</span><span class="sxs-lookup"><span data-stu-id="843be-104">Microsoft Holographic Remoting Software License Terms</span></span>
