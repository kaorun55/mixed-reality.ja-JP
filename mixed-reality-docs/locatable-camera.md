...
* 固定のフォーカス写真/ビデオ (PV) カメラでは、自動ホワイト バランス、自動公開、および完全なイメージ処理のパイプを使用
...
* 自動フォーカス写真/ビデオ (PV) カメラでは、自動ホワイト バランス、自動公開、および完全なイメージ処理のパイプを使用
* カメラがアクティブなときに世界が直面しているホワイト プライバシー LED が点灯します。
* カメラには、(すべてのビデオ モードはアスペクト比 16:9)、次のモードがサポートされています。

  >[!NOTE]
  >これらのモードは、HoloLens 2 一般公開前に変更される可能性が。

  |  Video  |  [プレビュー]  |  それでもなお  |  フレーム レート  |  水平視野 (FOV H) |  推奨される使用状況 | 
  |----------|----------|----------|----------|----------|----------|
  |  1920 x 1080 |  1920 x 1080 |  なし |  30、15 fps  |  54deg  |  (既定のモードでビデオ安定化) | 
  |  なし |  なし |  3904 X 2196 |  なし  |  64deg |  最高の解像度の静止画 | 
  |  2272 x 1278 |  2272 x 1278 |  なし |  30、15 fps  |  64deg |  ビデオ安定化する前にオーバー (埋め込み) の解決 | 
  |  1952 x 1100 |  1952 x 1100 |  1952 x 1100  |  30、15 fps  |  64deg |  高品質のストリーミング | 
  |  1280 x 720 |  1280 x 720 |  なし |  30、15、5 fps  |  64deg |  イメージ処理タスクのストリーミングと低電源/解像度モード | 
