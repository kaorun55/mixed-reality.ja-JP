...
HoloLens 2 では、開発者がユーザーの注目に関する情報を使用できるようにすることで、holographic experience 内で新しいレベルのコンテキストと人間の理解を実現できます。 このページでは、開発者とデザイナーに対するこの新機能の概要を説明します。さまざまなユースケースや基本的な開発者ガイドの視線追跡によってどのようにメリットが得られるかについて説明します。 
...
前述のように、視線追跡データが使用できない理由はいくつかあります。   
