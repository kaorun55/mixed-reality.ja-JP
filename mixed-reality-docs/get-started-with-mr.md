...
:::row:::
    :::column:::
       [![Mixed Reality を初めて使う](images/Tile-New.jpg)](get-started-with-mr.md#understand-the-basics)<br>
        **[Mixed Reality を初めて使う](get-started-with-mr.md#understand-the-basics)**<br>
        基本を理解する
    :::column-end:::
    :::column:::
