# <a name="2-getting-unity-ready-for-development"></a><span data-ttu-id="7c044-101">2. Unity を開発用に準備する</span><span class="sxs-lookup"><span data-stu-id="7c044-101">2. Getting Unity ready for development</span></span> 
