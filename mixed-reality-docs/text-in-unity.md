...
シャープで美しいテキスト](images/hug-text-02-640px.png) を取得する方法 ![<br>
...
Unity でフォントを操作 ![](images/640px-hug-text-03.png)<br>
...
さまざまなフォントサイズの Unity 3D テキストメッシュを ![](images/Text_In_Unity_Measurements1.png)<br>
*Unity 3D テキストと UI テキストの値のスケーリング*

<br>

さまざまなフォントサイズの Unity 3D テキストメッシュを ![](images/hug-text-05-1000px.png)<br>
...
ユニット値ごとに異なる動的ピクセルを持つ Unity UI テキストを ![](images/hug-text-04-1000px.png)<br>
...
さまざまなフォントサイズの Unity 3D テキストメッシュを ![](images/Text_In_Unity_Measurements2.png)<br>
*Unity 3D テキストと UI テキストの値のスケーリング*
...
適切なディメンションを使用した鋭いテキストレンダリング品質の ![](images/hug-text-06-1000px.png)<br>
...
オクルージョンサポートを使用した ![シェーダー](images/hug-text-07-1000px.png)<br>
*オクルージョンサポート付きのシェーダー*
